...
\begin{EntriesTable}
	...
	\Year{2021 (1h)}  &
	\textbf{How to ... support schools with plant biology webinar} -- Online - 
	STEM Ambassador, UK.
	\\

	\Year{2020}  &
	\textbf{Inspiring Young People in STEM: Communication Skills 
	for STEM Ambassadors} -- Online - 
	Future Learn, UK.
	\\
	...
	\Year{2019 (1h)}  &
	\textbf{Programming Foundations: Software Testing/QA} -- 
	Online - LinkedIn Learning.
	\\

	\Year{2019 (1h30)}  &
	\textbf{Learning Design for Sustainability} -- 
	Online - LinkedIn Learning.
	\\

	\Year{2019 (2h10)}  &
	\textbf{The Top 10 Project Management Mistakes—and How to Avoid Them} -- 
	Online - LinkedIn Learning.
	\\

	\Year{2019 (1h55)}  &
	\textbf{Comparing Agile versus Waterfall Project Management} -- 
	Online - LinkedIn Learning.
	\\
		
	\Year{2018 (24h)}  &
	\textbf{Starting a Nonprofit} -- Online - Gale Courses, USA.
	\\
\end{EntriesTable}
